...
export default function Document({
    ...
    return (
        <>
            ...
            <Row className="mb-2">
                <Form.Group className="mb-3">
                    <Form.Label className="me-2">มีความประสงค์ขอสอบ</Form.Label>
                    <Form.Check
                        inline
                        label="ความก้าวหน้า"
                        name="purpose"
                        type="radio"
                        value="progress"
                        checked={_formData["purpose"] === "progress"}
                        onChange={_onChange}
                        disabled
                    />
                    <Form.Check
                        ...
                        type="radio"
                        value="final"
                        checked={_formData["purpose"] === "final"}
                        onChange={_onChange}
                        disabled
                    />
                </Form.Group>
